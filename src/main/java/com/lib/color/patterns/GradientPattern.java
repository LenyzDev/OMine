package com.lib.color.patterns;
...
public class GradientPattern implements Pattern {
    ...
    public String process(String string) {
        ...
        while (matcher.find()) {
            ...
            string = string.replace(matcher.group(), Colors.color(content, new Color(Integer.parseInt(start, 16)), new Color(Integer.parseInt(end, 16))));
        }
        return string;
    }
